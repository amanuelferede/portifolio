export default function AboutMe() {
  return (
    <div className="max-w-7xl mx-auto pt-20" id="about">
      <p className="md:my-10 md:text-6xl text-3xl text-pink-400 text-center">
        About
      </p>
      <p className="md:text-justify md:w-4/5 w-full md:p-0 p-7 leading-relaxed text-2xl text-white">
      ...
      <p className="md:text-justify md:w-4/5 w-full md:p-0 p-7 leading-relaxed text-2xl text-white">
        ...
        UI and robust server-side logic to deliver seamless user experiences.
        Passionate about writing clean, maintainable code and optimizing API
      ...
      <p className="md:text-justify md:w-4/5 w-full md:p-0 p-7 leading-relaxed text-2xl text-white">
        ...
        efficiency, API optimization, and building scalable microservices.
        Experienced in collaborating with frontend teams to deliver end-to-end
        solutions.
      </p>
    </div>
  );
