...
export default function FbCloneApp() {
  return (
    <div
            ...
            <ul className="flex flex-col space-y-3 text-2xl list-disc">
              <li>
                <p className="font-semibold">
                  Next.js Authorization and authentication in next.js:{" "}
                </p>
              </li>

              <li>
                <p className="font-semibold">
                  Updating data in server actions:{" "}
                </p>
              </li>
              <li>
                <p className="font-semibold">
                  Database integrations with prisma ORM.
                </p>
              </li>
              <li>
                <p className="font-semibold">Data streaming.</p>
              </li>
              <li>
                <p className="font-semibold">
                  How to build different layout in tailwind css.
                </p>
              </li>
            </ul>
          </div>
